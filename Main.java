...
public class Main {
	public static void main(String[] args) {
		...
		//HistoricalEventTest tulsaRiot = new HistoricalEventTest(tulsaDescription, tulsaDay);
		HistoricalEventTest tulsaRiot = new HistoricalEventTest();
		...
		RevisedHistoricalEvent tulsaMassacre = new RevisedHistoricalEvent(tulsaDescription, tulsaDay, tulsaRevised,
				tulsaCitation);
